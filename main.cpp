...
//    A.Find(83);
 ...
 //   A.Print();
 //   qDebug()<<" ";
//    A.Adding(78,104,"asdf", 45,A.TailPtr);
//    A.Adding(35,32,"vas t", 46,A.TailPtr);
//    A.Adding(456,18,"erq", 325,A.TailPtr);
//    A.Print();
//    qDebug()<<" ";
//    A.Deletion(45);
 //   A.Print();
 //   A.Find(456);
//    qDebug()<<A.FindPtr->NSP;
//    qDebug()<<A.FindPtr->DecreeNumber;
//    qDebug()<<A.FindPtr->DrivLicenNumber;
//    qDebug()<<A.FindPtr->TotalFine;
//    qDebug()<<" ";
